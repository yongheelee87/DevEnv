...
class VoidExtract:
    def __init__(self):
        ...
        self.im_name = ''
        self.minArea = 0
        self.black_thresh = 0  # Black Thresh

    def update_params(self, image, img_name: str, min_area: int, thresh: int):
        self.im = image
    ...
    def get_image(self, result_path):
        ...
        img_name = '{}/Black_{}.jpg'.format(result_path, self.im_name[:self.im_name.find('.')])
